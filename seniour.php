...
$result = mysqli_query($conn, 'SELECT * FROM users WHERE title = "Chief Executive Officer" OR title = "General Manager"');
?>
<!DOCTYPE html>
<html>
<title>Senior Staffs</title>
<head>
    <meta charset="utf-8">
...
<div class = "container">
    ...
    <table class = "table table-striped table-hover table-bordered " data-toggle="table">
      ...
      <h2 class="text text-center">Senior Staffs</h2>
      <tr>
        <th>Username</th>
        <th>Email</th>
        <th>Positon</th>
